...
User-Agent Rotation: Thay đổi danh sách User-Agent ngẫu nhiên để mô phỏng nhiều trình duyệt v�� thiết bị khác nhau (Chrome, Safari, Firefox, Mobile).
...
Công cụ này chỉ được sử dụng trong môi trường Lab hoặc trên các hệ thống mà bạn có quyền sở hữu/cho phép kiểm thử.
Việc sử dụng công cụ này lên các mục tiêu công cộng mà không có sự cho phép có thể bị coi là hành vi tấn công DDoS và vi phạm pháp luật.
bạn hãy viết phần bên trên lại thành một file .readme để tôi up github
